...
import { AppBar, Box, Toolbar, IconButton, Menu, Container, Avatar, Tooltip, MenuItem, CardMedia, Link, Typography } from '@mui/material';
  ...
  return (
    <AppBar position='static' sx={headerBarWrapper}>
      <Container maxWidth={false} sx={headerWrapper}>
        <Toolbar>
          <CardMedia sx={headerDesktopLogoIcon} component='img' src={LogoIcon} alt='' onClick={() => navigate('/')} />
          ...
          <Box sx={headerMenuItemsBlockMob}>
                ...
                <MenuItem key={page.label} onClick={() => setAnchorElNav(null)}>
                  <Box sx={headerMenuItemBlock} key={page.label}>
                    <Link
                      ...
                      sx={[headerMobMenuItem, navLink, location.pathname === page.link ? headerActiveLink : {}]}
                    >
                      {page.label}
                    </Link>
                  </Box>
            ...
            <CardMedia sx={headerMobLogoIcon} component='img' src={LogoIcon} alt='' />
          </Box>
          ...
          <Box sx={headerMenuItemsBlockDesktop}>
            {pages.map((page) =>
              <Box sx={headerMenuItemBlock} key={page.label}>
                <Link
                  onClick={() => navigate(page.link)}
                  sx={[headerDesktopMenuItem, navLink, location.pathname === page.link ? headerActiveLink : {}]}
                >
                  {page.label}
                </Link>
              </Box>
              ...
              <MenuItem onClick={() => setAnchorElUser(null)}>
                <Box sx={headerMenuItemBlock}>
                  <Link
                    ...
                    sx={[headerDesktopMenuItem, navLink, location.pathname === '/dashboard' ? headerActiveLink : {}]}
                  >
                    Dashboard
                  </Link>
                </Box>
                ...
                <Box sx={headerMenuItemBlock}>
                  {isAuth
                    ...
                    : <Link
                      ...
                      sx={[headerDesktopMenuItem, navLink, location.pathname === '/login' ? headerActiveLink : {}]}
                    >
                      Login
                    </Link>
                  }
